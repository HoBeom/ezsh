...
if command -v zsh &> /dev/null && command -v git &> /dev/null && command -v wget &> /dev/null; then
    ...
    if apt install -y zsh git wget || pacman -S zsh git wget || dnf install -y zsh git wget || yum install -y zsh git wget || brew install git zsh wget || pkg install git zsh wget ; then
